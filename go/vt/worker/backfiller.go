...
func NewBackfiller(ctx context.Context, input ResultReader, destinationTableDefinition *tabletmanagerdatapb.TableDefinition, backfillStatus *backfillStatus,
	transform func([]sqltypes.Value) ([]sqltypes.Value, error),
